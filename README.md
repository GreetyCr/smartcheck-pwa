...
Abrir [http://localhost:3000](http://localhost:3000). Build: `pnpm build`. Producción: `pnpm start`. Lint: `pnpm lint`. Tests: `pnpm test` (Vitest: `lib/**/*.test.ts`, `tests/convex/**/*.test.ts`, `hooks/__tests__/**/*.test.tsx` y `lib/offline/__tests__` con **fake-indexeddb** / **happy-dom** donde aplica; ver `lib/offline/db.testing.ts` solo para resets en tests).
